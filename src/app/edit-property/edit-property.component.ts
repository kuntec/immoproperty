...
//const Basic_image_link = "http://api.nginxserver.info/";
const Basic_image_link = 'https://property-immo.herokuapp.com';
...
dropdownList = [];
  ...
  ngOnInit() {
    ...
    var retrievedData = localStorage.getItem("editPropery");
...
//   console.log(this.property_details);
  ...
  //  this.test_array[0] = 'zero';
  //  this.test_array[1] = 'one';
  //  this.test_array[2] = 'two';
   this.getAllAmenities();
  }

  onItemSelect(item: any) {
   // this.selectedItems.push(item);
    this.property_details.amenities.push(item)
   
    
  }
  onItemDeSelect(item: any) {
    var filtered = this.selectedItems.filter(function(value, index, arr){
  ...
  getAllAmenities(){
    this.amenitiesService.getAllAmenities().subscribe( (data) => { 
      ...
      this.selectedItems = this.property_details.amenities;
  ...
  onDrop(event: CdkDragDrop<string[]>) {
    ...
    this.goOrdering(this.property_details._id,'floor_plans',event.container.data);

 }
 onDropPhotos(event: CdkDragDrop<string[]>) {
  ...
  this.goOrdering(this.property_details._id,'photos',event.container.data);

}
// onDropFiles(event: CdkDragDrop<string[]>) {
...
//   }
//   this.goOrdering(this.property_details._id,'documents',event.container.data);

// }
  editBasicDetails(form: NgForm){
    ...
    this.propertyService.editBasicDetails(data).subscribe(
      data => {
        this.secondery = true;
        ...
        this.responseMessage = data.message
          ...
          //this.latitude = 333;
         // this.longitude = Number(this.long);
        // this.zoom = 15;
  ...
  goDeleteOne(templateId: any,field_name:any,media_name:any) {
    const data = { templateId: templateId ,field:field_name, name:media_name };

    this.propertyService.deleteOne(data).subscribe(
      data => {
  ...
  goOrdering(templateId: any,field_name:any,names:any) {
    const data = { templateId: templateId ,field:field_name, names:names };
 
    this.propertyService.ordering(data).subscribe(
      data => {
